...
<div class="breadcrumb-area"
  ...
  <div class="breadcrumb-area-overlay"
    style="background-color: #<?php echo e($be->breadcrumb_overlay_color); ?>;opacity: <?php echo e($be->breadcrumb_overlay_opacity); ?>;"></div>
</div>
<!--   breadcrumb area end    -->
        ...
        <form action="<?php echo e(route('front.sendquote')); ?>" enctype="multipart/form-data" method="POST">
          ...
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              ...
              <div class="row">
                <div class="col-lg-6">
                  <div class="form-element mb-4"><label><?php echo e(__('Primary Phone')); ?> <span>**</span></label>
                ...
                <div class="col-lg-6">
                  <div class="form-element mb-4"><label><?php echo e(__('Secondary Phone')); ?> <span></span></label>
                    <select class="col-lg-3" for="inlineFormInput" name="secondary_phone" id="secondary_phone"
                      required="required">
                      <option value="select">Select</option>
                      <option value="business">Business</option>
                      <option value="fax">Fax</option>
                    ...
                    <input class="col-lg-3" type="text" name="secondary_number" value="<?php echo e(old("contact_number")); ?>"
                      required="required">
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-lg-6">
                  <div class="form-element mb-4"><label><?php echo e(__('Payment Method')); ?> <span>**</span></label>
              ...
              <div class="row">
                <div class="col-lg-6" for="inlineFormInput">
                  <div class="form-element mb-4"><label><?php echo e(__('Move date')); ?> <span>**</span></label>
                    <input type="date" name="mdate" class="form-control" id="mdate" required="required">
                  </div>
                </div>

                <div class="col-lg-6">
                  <div class="form-element mb-4"><label><?php echo e(__('Follow Up date')); ?> <span>**</span></label>
                    <input type="date" name="fdate" class="form-control" id="fdate" required="required">
                  </div>
                </div>
              </div>
                  ...
                  <tr>
                    ...
                    <div class="row">
                      <div class="form-group col-md-4">
                        <input type="search" name="addsearch" id="inputCity" placeholder="Address Search">
                      </div>

                      <div class="form-group col-md-4">
                        <label for="c_inputbuild">Building Type</label>
                        <select name="c_inputbuild" id="c_inputbuild" class="form-control" required="required">
                      ...
                      <div class="form-group col-md-4">
                        ...
                        <select name="c_inputCountry" id="c_inputCountry" class="form-control" required="required">
                    ...
                    <div class="row">
                      <div class="form-group col-md-3">
                        ...
                        <input type="textbox" class="form-control" name="c_inputStreet" id="c_inputStreet"
                          required="required">
                      </div>

                      <div class="form-group col-md-3">
                        <label for="c_inputState">State</label>
                        <input type="textbox" class="form-control" name="c_inputState" id="c_inputState"
                          required="required">
                      </div>

                      <div class="form-group col-md-3">
                        <label for="c_inputCity">City</label>
                        <input type="textbox" class="form-control" name="c_inputCity" id="c_inputCity"
                          required="required">
                      </div>

                      <div class="form-group col-md-3">
                        <label for="c_inputZip">Zip</label>
                        <input type="textbox" class="form-control" name="c_inputZip" id="c_inputZip"
                          required="required">
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="form-group col-md-1">
                        ...
                        <input type="textbox" class="form-control" name="c_inputFloor" id="c_inputFloor"
                          required="required">
                      </div>

                      <div class="form-group col-md-1">
                        <label for="c_inputSqft">SQFT</label>
                        <input type="textbox" data-val="true" class="form-control" name="c_inputSqft" id="c_inputSqft"
                          value="0">
                      </div>

                      <div class="form-group col-md-1">
                        <label for="c_inputBedroom">Bedroom(s)</label>
                        <input type="textbox" class="form-control" name="c_inputBedroom" id="c_inputBedroom"
                          required="required">
                      </div>

                      <div class="form-group col-md-1">
                        <label for="c_inputMovers">Movers</label>
                        <input type="textbox" class="form-control" name="c_inputMovers" id="c_inputMovers">
                      </div>

                      <div class="form-group col-md-1">
                        <label for="c_inputTruck">Trucks</label>
                        <input type="textbox" class="form-control" name="c_inputTruck" id="c_inputTruck">
                      </div>
                    </div>
                  </tr>
                  ...
                  <tr>
                    ...
                    <div class="row">
                      ...
                      <div class="form-group col-md-4">
                        ...
                        <select name="p_inputbuild" id="p_inputbuild" class="form-control" required="required">
                          <option selected>select</option>
                          <option>Apartment</option>
                          <option>Basement</option>
                          <option>Condominium</option>
                      ...
                      <div class="form-group col-md-4">
                        ...
                        <select name="p_inputCountry" id="p_inputCountry" class="form-control" required="required">
                          <option selected>Choose Country</option>
                          <option>Canada</option>
                          <option>USA</option>
                        </select>
                    ...
                    <div class="row">
                      <div class="form-group col-md-3">
                        ...
                        <input type="textbox" class="form-control" name="p_inputStreet" id="p_inputStreet"
                          required="required">
                      </div>

                      <div class="form-group col-md-3">
                        <label for="p_inputState">State</label>
                        <input type="textbox" class="form-control" name="p_inputState" id="p_inputState"
                          required="required">
                      </div>

                      <div class="form-group col-md-3">
                        <label for="p_inputCity">City</label>
                        <input type="textbox" class="form-control" name="p_inputCity" id="p_inputCity"
                          required="required">
                      </div>

                      <div class="form-group col-md-3">
                        <label for="p_inputZip">Zip</label>
                        <input type="textbox" class="form-control" name="p_inputZip" id="p_inputZip"
                          required="required">
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="form-group col-md-1">
                        ...
                        <input type="textbox" class="form-control" name="p_inputFloor" id="p_inputFloor"
                          required="required">
                      </div>

                      <div class="form-group col-md-1">
                        <label for="p_inputSqft">SQFT</label>
                        <input type="textbox" data-val="true" class="form-control" name="p_inputSqft" id="p_inputSqft"
                          value="0">
                      </div>

                      <div class="form-group col-md-1">
                        <label for="p_inputBedroom">Bedroom(s)</label>
                        <input type="textbox" class="form-control" name="p_inputBedroom" id="p_inputBedroom"
                          required="required">
                      </div>

                      <div class="form-group col-md-1">
                        <label for="p_inputMovers">Movers</label>
                        <input type="textbox" class="form-control" name="p_inputMovers" id="p_inputMovers">
                      </div>

                      <div class="form-group col-md-1">
                        <label for="p_inputTruck">Trucks</label>
                        <input type="textbox" class="form-control" name="p_inputTruck" id="p_inputTruck"
                          required="required">
                      </div>
                    </div>
                  </tr>
          ...
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              <div style="width:50%; padding:0px 5px;float:left;" id="bases" onchange="fillBaseFields()">
                <select id="closestLocations" name="closestLocations" class="form-control" style="width:100%"></select>
                ...
                <tr>
                  <div class="row">
                    <div class="form-group col-md-2">
                      <button type="button" class="btn btn-secondary" name="GetEstimate" id="getEstimate">Get
                        Estimate</button>
                    </div>
                    <div class="form-group col-md-3">
                      <label for="truck_fee">TruckFee/FlatRate</label>
                      <input type="textbox" data-val="true" class="form-control" name="truck_fee" id="truck_fee"
                        value="0">
                    </div>
                    <div class="form-group col-md-3">
                      <label for="hourly_rate">HourlyRate</label>
                      <input type="textbox" data-val="true" class="form-control" name="hourly_rate" id="hourly_rate"
                        value="0">
                    </div>
                  </div>
                </tr>
...
<!--   quote area end   -->
<?php $__env->stopSection(); ?>
<?php echo $__env->make("front.$version.layout", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\logistics\core\resources\views/front/quote.blade.php ENDPATH**/ ?>