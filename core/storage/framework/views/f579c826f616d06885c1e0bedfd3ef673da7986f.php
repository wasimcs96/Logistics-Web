          ...
          <div class="card-title">
              <div class="row">
                  ...
                  <div class="col-lg-6 text-right">
                    <a class="btn btn-primary" href="<?php echo e(route('admin.quote.form') . '?language=' . request()->input('language')); ?>">Back</a>
                  </div>
              </div>
          </div>
        </div>
        ...
        <div class="card-body">
            <div class="row" id="app">
                ...
                <div class="col-lg-6 offset-lg-3">
                    <form id="ajaxForm" action="<?php echo e(route('admin.quote.inputUpdate')); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="selectgroup w-100">
                                <label class="selectgroup-item">
                                    <input type="radio" name="active" value="1" class="selectgroup-input" <?php echo e($input->active == 1 ? 'checked' : ''); ?>>
                                    <span class="selectgroup-button">Yes</span>
                                </label>
                                <label class="selectgroup-item">
                                    <input type="radio" name="active" value="0" class="selectgroup-input" <?php echo e($input->active == 0 ? 'checked' : ''); ?>>
                                    <span class="selectgroup-button">No</span>
                                </label>
                            </div>
                        ...
                        <?php if($input->type != 3 && $input->type != 5): ?>
                            <div class="form-group">
...
<?php $__env->startSection('vuescripts'); ?>
  <script>
    var app = new Vue({
      ...
      created() {
        $.get("<?php echo e(route('admin.quote.options', $input->id)); ?>", (data) => {
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\logistics\core\resources\views/admin/quote/form-edit.blade.php ENDPATH**/ ?>