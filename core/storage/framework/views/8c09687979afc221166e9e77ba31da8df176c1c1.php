        ...
        <div class="breadcrumb-txt">
           <div class="row">
              <div class="col-xl-7 col-lg-8 col-sm-10">
                 <span><?php echo e(__('Package Order')); ?></span>
                 <h1><?php echo e(__('Place Order for')); ?> <p class="d-inline-block" style="color:#<?php echo e($bs->base_color); ?>;"><?php echo e(convertUtf8($package->title)); ?></p></h1>
                 <ul class="breadcumb">
