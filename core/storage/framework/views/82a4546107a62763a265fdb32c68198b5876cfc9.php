<?php $__env->startSection('content'); ?>
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="card">
        <form id="socialForm" action="<?php echo e(route('admin.social.store')); ?>" method="post" onsubmit="store(event)">
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\logistics\core\resources\views/admin/basic/social/index.blade.php ENDPATH**/ ?>