<div class="modal fade" id="createStatisticModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
   <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
         <form id="ajaxForm" class="modal-form" action="<?php echo e(route('admin.statistics.store')); ?>" method="POST">
...
<?php /**PATH D:\xampp\htdocs\logistics\core\resources\views/admin/home/statistics/create.blade.php ENDPATH**/ ?>