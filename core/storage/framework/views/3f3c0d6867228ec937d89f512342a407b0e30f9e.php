        ...
        <div class="card-header">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <a href="<?php echo e(route('admin.quote.addQuote')); ?>" class="btn btn-primary float-right"><i class="fas fa-plus"></i> Add
                      Quote</a>
                </div>
                <div class="col-lg-6">
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\logistics\core\resources\views/admin/quote/quote.blade.php ENDPATH**/ ?>