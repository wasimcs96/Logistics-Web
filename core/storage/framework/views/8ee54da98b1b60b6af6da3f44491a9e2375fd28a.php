                    ...
                    <tbody>
                      <?php $__currentLoopData = $aulinks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $aulink): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                          ...
                          <td><?php echo e(convertUtf8($aulink->name)); ?></td>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\logistics\core\resources\views/admin/footer/ulink/index.blade.php ENDPATH**/ ?>