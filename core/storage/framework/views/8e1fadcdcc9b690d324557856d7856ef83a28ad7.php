        ...
        <div class="breadcrumb-txt">
           <div class="row">
              <div class="col-xl-7 col-lg-8 col-sm-10">
                <span><?php echo e($be->rss_title); ?></span>
                 <h1><?php echo e($be->rss_subtitle); ?></h1>
                 <ul class="breadcumb">
                    <li><a href="<?php echo e(route('front.index')); ?>"><?php echo e(__('Home')); ?></a></li>
                    <li><?php echo e(__('Latest RSS Feeds')); ?></li>
                 </ul>
              </div>
           </div>
        </div>
        ...
        <div class="row">
           <div class="col-lg-8">
              ...
              <?php if($rss_posts->total() > 4): ?>
                <div class="row">
                   <div class="col-md-12">
                      <nav class="pagination-nav <?php echo e($rss_posts->total() > 6 ? 'mb-4 mt-2' : ''); ?>">
                        <?php echo e($rss_posts->links()); ?>
...
<?php echo $__env->make("front.logistic.layout", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\logistics\core\resources\views/front/logistic/rss.blade.php ENDPATH**/ ?>