        ...
        <div class="card-body pt-5 pb-4">
          <div class="row">
            <div class="col-lg-6 offset-lg-3">
              <form class="mb-3 dm-uploader drag-and-drop-zone" enctype="multipart/form-data" action="<?php echo e(route('admin.logo.update', $lang_id)); ?>" method="POST">
                <div class="form-row">
                  <div class="col-md-12 d-md-block d-sm-none mb-3">
                    <?php if(!empty($abs->logo)): ?>
                        <img src="<?php echo e(asset('assets/front/img/'.$abs->logo)); ?>" alt="..." class="img-thumbnail">
                    <?php else: ?>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\logistics\core\resources\views/admin/basic/logo.blade.php ENDPATH**/ ?>