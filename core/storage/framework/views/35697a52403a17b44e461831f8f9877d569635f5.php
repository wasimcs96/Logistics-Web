              ...
              <li>
                <div class="user-box">
                  ...
                  <div class="u-text">
                    ...
                    <p class="text-muted"><?php echo e(Auth::guard('admin')->user()->email); ?></p><a href="<?php echo e(route('admin.editProfile')); ?>" class="btn btn-xs btn-secondary btn-sm">Edit Profile</a>
                  </div>
                </div>
              </li>
              <li>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="<?php echo e(route('admin.editProfile')); ?>">Edit Profile</a>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="<?php echo e(route('admin.changePass')); ?>">Change Password</a>
                <div class="dropdown-divider"></div>
...
<?php /**PATH C:\xampp\htdocs\logistics\core\resources\views/admin/partials/top-navbar.blade.php ENDPATH**/ ?>