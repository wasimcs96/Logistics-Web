                ...
                <div class="form-group">
                  <label for="">Permissions: </label>
                	<div class="selectgroup selectgroup-pills mt-2">
						...
						<label class="selectgroup-item">
                			<input type="checkbox" name="permissions[]" value="Leads" class="selectgroup-input" @if(is_array($permissions) && in_array('Leads', $permissions)) checked @endif>
						...
						<!-- <label class="selectgroup-item">
                			<input type="checkbox" name="permissions[]" value="Order" class="selectgroup-input" @if(is_array($permissions) && in_array('orders', $permissions)) checked @endif>
